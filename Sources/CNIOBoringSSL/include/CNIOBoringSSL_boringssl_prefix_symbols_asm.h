...
#define _EVP_HPKE_CTX_get_aead_id BORINGSSL_ADD_PREFIX_MAC_ASM(BORINGSSL_PREFIX, EVP_HPKE_CTX_get_aead_id)
#define _EVP_HPKE_CTX_get_kdf_id BORINGSSL_ADD_PREFIX_MAC_ASM(BORINGSSL_PREFIX, EVP_HPKE_CTX_get_kdf_id)
...
#define _SSL_CTX_set1_ech_server_config_list BORINGSSL_ADD_PREFIX_MAC_ASM(BORINGSSL_PREFIX, SSL_CTX_set1_ech_server_config_list)
...
#define _SSL_ECH_SERVER_CONFIG_LIST_add BORINGSSL_ADD_PREFIX_MAC_ASM(BORINGSSL_PREFIX, SSL_ECH_SERVER_CONFIG_LIST_add)
#define _SSL_ECH_SERVER_CONFIG_LIST_free BORINGSSL_ADD_PREFIX_MAC_ASM(BORINGSSL_PREFIX, SSL_ECH_SERVER_CONFIG_LIST_free)
#define _SSL_ECH_SERVER_CONFIG_LIST_new BORINGSSL_ADD_PREFIX_MAC_ASM(BORINGSSL_PREFIX, SSL_ECH_SERVER_CONFIG_LIST_new)
