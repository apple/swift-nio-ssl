...
#define SIKE_decaps BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, SIKE_decaps)
#define SIKE_encaps BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, SIKE_encaps)
#define SIKE_keypair BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, SIKE_keypair)
...
#define SSL_CTX_enable_pq_experiment_signal BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, SSL_CTX_enable_pq_experiment_signal)
...
#define SSL_CTX_set_rsa_pss_rsae_certs_enabled BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, SSL_CTX_set_rsa_pss_rsae_certs_enabled)
...
#define SSL_pq_experiment_signal_seen BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, SSL_pq_experiment_signal_seen)
...
#define gcm_ghash_4bit BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, gcm_ghash_4bit)
...
#define gcm_gmult_4bit BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, gcm_gmult_4bit)
...
#define gcm_init_4bit BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, gcm_init_4bit)
...
#define sike_cswap_asm BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_cswap_asm)
#define sike_eval_3_isog BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_eval_3_isog)
#define sike_eval_4_isog BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_eval_4_isog)
#define sike_fp2inv_mont BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_fp2inv_mont)
#define sike_fp2mul_mont BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_fp2mul_mont)
#define sike_fp2sqr_mont BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_fp2sqr_mont)
#define sike_fpadd BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_fpadd)
#define sike_fpcopy BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_fpcopy)
#define sike_fpcorrection BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_fpcorrection)
#define sike_fpdiv2 BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_fpdiv2)
#define sike_fpmul_mont BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_fpmul_mont)
#define sike_fpneg BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_fpneg)
#define sike_fprdc BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_fprdc)
#define sike_fpsub BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_fpsub)
#define sike_from_mont BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_from_mont)
#define sike_get_3_isog BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_get_3_isog)
#define sike_get_4_isog BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_get_4_isog)
#define sike_get_A BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_get_A)
#define sike_inv_3_way BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_inv_3_way)
#define sike_j_inv BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_j_inv)
#define sike_mpadd_asm BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_mpadd_asm)
#define sike_mpdblsubx2_asm BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_mpdblsubx2_asm)
#define sike_mpmul BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_mpmul)
#define sike_mpsubx2_asm BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_mpsubx2_asm)
#define sike_params BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_params)
#define sike_xDBLADD BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_xDBLADD)
#define sike_xDBLe BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_xDBLe)
#define sike_xTPL BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_xTPL)
#define sike_xTPLe BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sike_xTPLe)
...
#define sk_CertCompressionAlg_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_call_free_func)
#define sk_CertCompressionAlg_call_copy_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_call_copy_func)
#define sk_CertCompressionAlg_call_cmp_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_call_cmp_func)
#define sk_CertCompressionAlg_new BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_new)
#define sk_CertCompressionAlg_new_null BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_new_null)
#define sk_CertCompressionAlg_num BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_num)
#define sk_CertCompressionAlg_zero BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_zero)
#define sk_CertCompressionAlg_value BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_value)
#define sk_CertCompressionAlg_set BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_set)
#define sk_CertCompressionAlg_free BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_free)
#define sk_CertCompressionAlg_pop_free BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_pop_free)
#define sk_CertCompressionAlg_insert BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_insert)
#define sk_CertCompressionAlg_delete BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_delete)
#define sk_CertCompressionAlg_delete_ptr BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_delete_ptr)
#define sk_CertCompressionAlg_find BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_find)
#define sk_CertCompressionAlg_shift BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_shift)
#define sk_CertCompressionAlg_push BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_push)
#define sk_CertCompressionAlg_pop BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_pop)
#define sk_CertCompressionAlg_dup BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_dup)
#define sk_CertCompressionAlg_sort BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_sort)
#define sk_CertCompressionAlg_is_sorted BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_is_sorted)
#define sk_CertCompressionAlg_set_cmp_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_set_cmp_func)
#define sk_CertCompressionAlg_deep_copy BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CertCompressionAlg_deep_copy)
