...
#define CRYPTO_addc_impl BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, CRYPTO_addc_impl)
#define CRYPTO_subc_impl BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, CRYPTO_subc_impl)
